...
data["ArenaS3PvP"] = {
	...
	items = {
		...
		
		{
			name = ALIL["Trinket"],
			[NORMAL_DIFF] = {
				{ 1, 34576 }, -- Battlemaster's Cruelty
				{ 2, 34577 }, -- Battlemaster's Depravity
				{ 3, 34578 }, -- Battlemaster's Determination
				{ 4, 34579 }, -- Battlemaster's Audacity
				{ 5, 34580 }, -- Battlemaster's Perserverence
				{ 6, 35327 }, -- Battlemaster's Alacrity
			},
		},
